...
![](https://github.com/Ridham0008/Network_login_LNMIIT.git)
A chrome extension to ease off the login functionality of the LNMIIT current login portal.
...
## Is it safe to use?
Definately! its just a bot doing things for you nothing fancy. A person with very little knowledge of javascript can tell you that not a single piece of information is going anywhere.
...
3, Open google chrome ->'more tools'->'Extentions'
